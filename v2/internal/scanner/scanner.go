...
import (
	...
	"errors"
	"fmt"
	"github.com/SecuriWiser/nuclei/v2/internal/kafka"
	"io"
	"os"
	"path/filepath"
	"runtime"
	...
	"github.com/SecuriWiser/nuclei/v2/internal/runner"
	...
	"github.com/SecuriWiser/nuclei/v2/pkg/utils/monitor"
...
func readConfig(options *types.Options, cfgFile *string, memProfile *string, domain string) *goflags.FlagSet {
...
on extensive configurability, massive extensibility and ease of use.`)
	...
	*/
	...
	flagSet.CreateGroup("input", "Target",
		flagSet.StringSliceVarP(&options.Targets, "target", "u", []string{domain}, "target URLs/hosts to scan", goflags.StringSliceOptions),
